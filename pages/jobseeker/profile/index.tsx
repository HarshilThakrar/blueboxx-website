          ...
          <AnimatedContent direction="up" delay={0.1} className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden relative">
            ...
            <div className="px-8 pb-8 relative">
              ...
              <div className="pt-16 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                {profile.resume_path ? (
                  <a href={`/storage/${profile.resume_path}`} target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 bg-[#C9A227] hover:bg-[#b08d22] text-[#0d1635] font-bold rounded-xl shadow-md transition-colors text-sm flex items-center gap-2">
                    <Download size={16} /> Download Resume
                  </a>
                ) : (
                  <button onClick={() => setActiveModal('download-resume')} className="px-5 py-2.5 bg-slate-100 text-slate-500 font-bold rounded-xl shadow-sm text-sm flex items-center gap-2 cursor-not-allowed">
