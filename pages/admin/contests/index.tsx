...
import { 
  Trophy, Plus, Edit2, Trash2, CheckCircle, XCircle, Users, AlertCircle, FileText, Upload, Clock, List
} from 'lucide-react';
...
const dummyContests: Contest[] = [
  { id: '1', title: 'Global Coding Challenge 2023', type: 'Hackathon', startDate: '2023-11-01', endDate: '2023-11-03', participants: 450, status: 'Upcoming' },
  { id: '2', title: 'UI/UX Design Sprint', type: 'Design', startDate: '2023-10-25', endDate: '2023-10-30', participants: 120, status: 'Active' },
  { id: '3', title: 'Data Science Datathon', type: 'Data', startDate: '2023-09-10', endDate: '2023-09-12', participants: 300, status: 'Completed' },
];
...
export default function ContestsManager() {
  ...
  const contestCols = [
    ...
    { key: 'status', label: 'Status', render: (r: Contest) => <span className={`px-2 py-1 rounded text-xs font-bold ${getStatusColor(r.status)}`}>{r.status}</span> },
    { key: 'actions', label: 'Actions', render: (r: Contest) => (
      <div className="flex gap-2">
        ...
        <button className="p-1.5 text-gray-600 hover:bg-gray-100 rounded" title="Edit"><Edit2 size={16}/></button>
      </div>
    )}
  ];
  ...
  return (
    <AdminDashboardLayout>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <button className="flex items-center gap-2 bg-[#1B2A6B] hover:bg-[#121c47] text-white px-4 py-2 rounded-lg font-bold text-sm shadow-md transition-colors">
      ...
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
        {activeTab === 'Contests' && <DataTable data={contests} columns={contestCols} />}
