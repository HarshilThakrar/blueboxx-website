...
import {
  ...
  Trash2, User, Building2, Calendar, FileText, Upload, Clock, Plus, Star,
  RefreshCw, Filter, Download, ChevronLeft, ChevronRight, Loader2, AlertCircle as AlertIcon
} from 'lucide-react';
...
export default function InternshipManager() {
  ...
  const handleExport = () => {
    InternshipService.exportCSV(filterStatus || undefined);
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <p className="text-sm font-semibold text-gray-700">
                            {prog.company?.first_name} {prog.company?.last_name || ''}
                          </p>
                        </div>
                      </td>
                      <td className="px-6 py-4">
