...
import { MessageSquare, Phone, Mail, ChevronRight, HelpCircle, Send, Paperclip, Clock, CheckCircle2, AlertCircle } from "lucide-react";
...
export default function CompanySupportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post('/company/support/tickets', payload);
      setSubmitted(true);
