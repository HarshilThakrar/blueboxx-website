...
import { DollarSign, ArrowUpRight, ArrowDownRight, Download, History, CreditCard, Filter, Shield } from "lucide-react";
...
export default function ExpertEarnings() {
  ...
  const handleWithdrawal = () => {
    ...
    setTimeout(() => {
      toast.success("Withdrawal of $450.00 requested successfully!", { id: toastId });
    }, 1500);
  };
