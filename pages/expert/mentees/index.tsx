...
import { Search, Filter, MoreHorizontal, MessageSquare, Star, User, ChevronDown, CheckSquare, XSquare, Archive } from "lucide-react";
  ...
  return (
    <ExpertDashboardLayout>
      <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          <h1 className="text-2xl font-black text-[#0d1635] mb-1">My Mentees</h1>
          <p className="text-slate-500 font-medium text-sm">Track progress, review feedback, and manage your active mentees.</p>
        </div>
      </div>
        ...
        {filteredMentees.length === 0 ? (
          <div className="p-8">
            <EmptyState 
              ...
              title={mentees.length === 0 ? "No Mentees Yet" : "No results found"} 
              description={mentees.length === 0 ? "You haven't accepted any mentees yet. Check your dashboard for pending requests." : "Try adjusting your search or filters to find what you're looking for."}
          ...
          <div className="overflow-x-auto">
            ...
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100">
                <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-wider">Mentee Name</th>
