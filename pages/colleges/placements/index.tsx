...
import { Building2, Search, Filter, Briefcase, Plus, MoreVertical, MapPin, CheckCircle2, ChevronDown, MessageSquare, ExternalLink, XCircle, SearchX } from "lucide-react";
...
export default function CollegePlacements() {
  ...
  const renderCard = (item: PlacementData, index: number, colorClass: string, bgClass: string, Icon?: any) => (
    <div
      key={item.id}
      draggable
    ...
    <CollegesDashboardLayout>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        ...
        <div className="relative">
          ...
          <AnimatePresence>
            {isFilterOpen && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 10 }} className="absolute right-0 top-full mt-2 w-56 bg-white border border-slate-200 rounded-xl shadow-lg z-20 py-2">
