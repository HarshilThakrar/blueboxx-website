...
export default function SettingsPage() {
  ...
  const [form, setForm] = useState({
    name: user?.name ?? "Rahul Singh",
    email: user?.email ?? "rahul@example.com",
    phone: "+91 9876543210",
    location: "Bangalore, India",
    bio: "Passionate frontend developer looking for exciting opportunities.",
  });
            ...
            {activeTab === "Privacy" && (
              <div className="space-y-4">
                ...
                <div className="pt-4">
                  ...
                  }} className="text-sm font-bold text-red-500 hover:text-red-700 transition-colors">Delete Account</button>
                </div>
              </div>
            )}
