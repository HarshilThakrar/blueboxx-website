    ...
    <StudentDashboardLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {[
          ...
          { id: "stat-interviews", label: "Interviews Scheduled", value: 0, icon: Calendar, color: "text-amber-600", bg: "bg-amber-50", href: "/student/applications" },
          { id: "stat-offers", label: "Offers Received", value: 0, icon: Trophy, color: "text-emerald-600", bg: "bg-emerald-50", href: "/student/applications" },
        ].map((stat, i) => (
