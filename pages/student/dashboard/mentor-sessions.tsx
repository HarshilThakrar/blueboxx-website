...
import { Calendar, Clock, Video, FileText, Star, User, ChevronRight, PlayCircle } from "lucide-react";
  ...
  const upcomingSessions = [
    {
      ...
      topic: "React Architecture & Performance",
      date: "Oct 24, 2026",
      time: "4:00 PM - 5:00 PM",
      status: "scheduled",
      image: "https://ui-avatars.com/api/?name=Ankit+Sharma&background=1B2A6B&color=fff",
    }
  ];
  ...
  const pastSessions = [
    {
      id: 2,
      mentor: "Priya Desai",
      role: "UX Design Lead at Microsoft",
      topic: "Portfolio Review & Feedback",
      date: "Oct 10, 2026",
      time: "2:00 PM - 3:00 PM",
      status: "completed",
      image: "https://ui-avatars.com/api/?name=Priya+Desai&background=C9A227&color=fff",
  ...
  const availableMentors = [
    {
      id: 1,
      name: "Rahul Verma",
      role: "Full Stack Lead at Amazon",
    ...
    },
    {
      ...
      expertise: ["Java", "Microservices", "DSA"],
      rating: 4.8,
      reviews: 210,
                ...
                <div className="divide-y divide-slate-50">
                  {availableMentors.map((mentor) => (
                    <div key={mentor.id} className="p-5 flex items-start gap-4 hover:bg-slate-50 transition-colors group cursor-pointer relative overflow-hidden">
                      ...
                      <img src={mentor.image} alt={mentor.name} className="w-12 h-12 rounded-full shadow-sm group-hover:scale-105 transition-transform" />
