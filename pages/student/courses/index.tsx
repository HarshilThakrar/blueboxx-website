...
export default function MyCoursesPage() {
  ...
  React.useEffect(() => {
    api.get("/student/courses")
      .then((res) => {
        const active = res.data.data.active.map((c: any) => ({
          ...c,
          status: "active",
          thumb: c.thumbnail || "https://images.unsplash.com/photo-1633356122544-f134324a6cee?q=80&w=400&auto=format&fit=crop"
        }));
        const completed = res.data.data.completed.map((c: any) => ({
          ...c,
          status: "completed",
          thumb: c.thumbnail || "https://images.unsplash.com/photo-1633356122544-f134324a6cee?q=80&w=400&auto=format&fit=crop"
        }));
