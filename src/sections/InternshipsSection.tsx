...
const internships = [
  { title: "Web Development", icon: Code, slug: "web-development" },
  { title: "UI/UX Design", icon: PenTool, slug: "ui-ux-design" },
  { title: "Digital Marketing", icon: TrendingUp, slug: "digital-marketing" },
  { title: "Artificial Intelligence", icon: Cpu, slug: "artificial-intelligence" },
  { title: "Data Analytics", icon: BarChart, slug: "data-analytics" },
