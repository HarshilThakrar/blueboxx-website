...
import { 
  LayoutDashboard, GraduationCap, BarChart3, Settings, LogOut, ChevronRight, School, Users, FileSpreadsheet
} from "lucide-react";
...
const sidebarLinks = [
  { group: "Overview", items: [
    ...
    { name: "Student Roster", href: "/college/students", icon: Users },
  ]},
  { group: "Placement", items: [
    { name: "Drive Analytics", href: "/college/analytics", icon: BarChart3 },
    { name: "Partner Companies", href: "/college/partners", icon: School },
    { name: "Reports", href: "/college/reports", icon: FileSpreadsheet },
  ]},
  { group: "Institute", items: [
    { name: "College Profile", href: "/college/profile", icon: GraduationCap },
    { name: "Settings", href: "/college/settings", icon: Settings },
  ]}
];

export const CollegeLayout = ({ children }: { children: ReactNode }) => {
              ...
              <div className="bg-white rounded-3xl border border-slate-100 shadow-[0_8px_30px_rgba(27,42,107,0.04)] overflow-hidden sticky top-28">
                ...
                <div className="p-5 border-b border-slate-100 flex items-center gap-4 bg-[#0d1635] text-white">
                  <div className="relative">
                    <img src="https://ui-avatars.com/api/?name=VIT&background=C9A227&color=fff" alt="Logo" className="w-12 h-12 rounded-xl border-2 border-[#C9A227] shadow-md object-cover bg-white" />
                  </div>
                  <div>
                    <div className="font-extrabold text-white text-[13px] leading-tight">VIT University</div>
                    <div className="text-[9px] font-bold text-[#C9A227] uppercase tracking-wider mt-0.5">Placement Cell</div>
                  </div>
                </div>
