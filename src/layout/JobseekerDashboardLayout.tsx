...
import { LayoutDashboard, Target, FileText, Settings, LogOut, Menu, X, Bell, Search, Calendar, Gift, User } from "lucide-react";
          ...
          <div className="mt-auto p-6 space-y-6">
            <div className="flex items-center gap-3 px-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Job Portal</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex relative">
                ...
                <input 
                  ...
                  className="pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-64 transition-shadow"
                />
              </div>
            </div>
