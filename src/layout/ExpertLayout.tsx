...
import { 
  LayoutDashboard, Calendar, DollarSign, User, Settings, LogOut, ChevronRight, Video, FileText, Star
} from "lucide-react";
...
const sidebarLinks = [
  { group: "Overview", items: [
    ...
    { name: "My Sessions", href: "/expert/sessions", icon: Calendar },
    { name: "Earnings", href: "/expert/earnings", icon: DollarSign },
  ]},
  { group: "Management", items: [
    { name: "Availability", href: "/expert/availability", icon: Calendar },
    { name: "Reviews", href: "/expert/reviews", icon: Star },
    { name: "Resources", href: "/expert/resources", icon: FileText },
  ]},
  { group: "Account", items: [
              ...
              <div className="bg-white rounded-3xl border border-slate-100 shadow-[0_8px_30px_rgba(27,42,107,0.04)] overflow-hidden sticky top-28">
                ...
                <div className="p-5 border-b border-slate-100 flex items-center gap-4 bg-[#0d1635] text-white">
                  <div className="relative">
                    <img src="https://ui-avatars.com/api/?name=Ankit+Sharma&background=C9A227&color=fff" alt="Avatar" className="w-12 h-12 rounded-full border-2 border-[#C9A227] shadow-md object-cover" />
                    <span className="absolute bottom-0 right-0 w-3 h-3 bg-emerald-500 border-2 border-[#0d1635] rounded-full"></span>
                  </div>
                  <div>
                    <div className="font-extrabold text-white text-sm leading-tight">Ankit Sharma</div>
                    <div className="text-[10px] font-bold text-[#C9A227] uppercase tracking-wider mt-0.5">Expert Mentor</div>
                  </div>
                </div>
